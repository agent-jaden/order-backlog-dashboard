...
MANUAL_NO_BACKLOG_STOCK_CODES = {
    ...
    "900340",  # 윙입푸드
    "005430",  # 한국공항
    "000480",  # 시알홀딩스 — 수주총액이 매출 개념, 수주잔고 아님
    "462520",  # 조선내화 — 수주총액이 매출 개념, 수주잔고 아님
    "092200",  # 디아이씨 — 수주잔고 없음
    "008830",  # 대동기어 — 수주잔고 없음
    "088390",  # 이녹스 — 타사(알톤) 수주잔고와 동일, 파싱 오류
    "008060",  # 대덕 — 자회사(대덕전자) 수주잔고와 동일
    "003550",  # LG — 자회사(LG씨엔에스) 수주잔고와 동일
}
